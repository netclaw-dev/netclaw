# notification-webhook-cli Specification

## Purpose

Define offline CLI behavior for managing notification webhook targets with
secret-safe persistence, selector semantics, and explicit probe execution.
