...
- [ ] 2.2.1 Add runtime-owned memory security boundaries so reusable project/entity memories can cross channels inside the same authorized boundary without depending on channel-derived domains.
