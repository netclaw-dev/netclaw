...
public sealed class SlackChannel : IChannel, IEventHandler<MessageEvent>, IEventHandler<AppMention>
{
    ...
    public SlackChannel(
        ...
        ISlackThreadCursorStore? threadCursorStore = null)
    {
        _pipeline = pipeline;
        _system = system;
        _slack = slack;
        ...
        _threadCursorStore = threadCursorStore ?? NullSlackThreadCursorStore.Instance;
    }
        ...
        try
        {
            ...
            _gateway = _system.ActorOf(
                SlackGatewayActor.CreateProps(new SlackGatewayDependencies(
                    ...
                    ThreadCursorStore: _threadCursorStore)),
                "slack-gateway");
