...
| pwsh-static-authored-cmdlet-grants-allow | Personal | Project | Interactive | pwsh -NoProfile -NonInteractive -Command 'Write-Output ready' | persistent[anywhere]:pwsh, persistent[anywhere]:Write-Output | Allowed | StoredApproval | none | Not applicable |
| pwsh-static-authored-pipeline-checks-every-stage | Personal | Project | Interactive | pwsh -NoProfile -NonInteractive -Command 'Get-ChildItem \| Remove-Item' | persistent[anywhere]:pwsh, persistent[anywhere]:Get-ChildItem | RequiresApproval | approval required | Remove-Item | No |
| pwsh-static-authored-pipeline-grants-allow | Personal | Project | Interactive | pwsh -NoProfile -NonInteractive -Command 'Get-ChildItem \| Remove-Item' | persistent[anywhere]:pwsh, persistent[anywhere]:Get-ChildItem, persistent[anywhere]:Remove-Item | Allowed | StoredApproval | none | Not applicable |
...
| pwsh-write-output-script-block-stays-data | Personal | Project | Interactive | pwsh -NoProfile -NonInteractive -Command 'Write-Output { Remove-Item target.txt }' | persistent[anywhere]:pwsh, persistent[anywhere]:Write-Output | Allowed | StoredApproval | none | Not applicable |
| pwsh-source-mutated-write-output-stays-strict | Personal | Project | Interactive | pwsh -NoProfile -NonInteractive -Command 'Set-Alias Write-Output Invoke-Command; Write-Output { Remove-Item target.txt }' | persistent[anywhere]:pwsh, persistent[anywhere]:Set-Alias, persistent[anywhere]:Write-Output, persistent[anywhere]:Remove-Item | RequiresApproval | approval required | none | Yes |
