...
- [x] Interactive Bash approval can use an exact leading `cd` target as the
  intended scope for a safe read-only sequence tail. Execution, display, and
  model history preserve the authored call.
