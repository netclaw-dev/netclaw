...
public sealed class ProviderManagerViewModelTests : IDisposable
{
    ...
    public void DisplayProviders_ShowsAllKnownTypes()
    {
        ...
        foreach (var type in new[] { "ollama", "openai", "anthropic", "openrouter", "openai-compatible", "github-copilot", "veniceai", "deepseek", "zai" })
        {
    ...
    public void DisplayProviders_ShowsMultipleInstancesOfSameType()
    {
        ...
        // Total: 2 configured + 8 unconfigured types = 10
        Assert.Equal(10, vm.DisplayProviders.Count);
    }
